...
def create_game_map():
    game_map = GameMap("assets/map/sky.jpeg", "assets/map/ground2.png")
    # Add the new background layer
    game_map.add_background_layer("assets/map/background2.png", 3.55)
    return game_map
...
def create_platforms(ground):
    return [
        # 2 tiles
        Platform("assets/map/platform2.png", 2000, ground - 30, 100, 20),
        Platform("assets/map/platform2.png", 2100, ground - 80, 100, 20),
        ...
        Platform("assets/map/platform2.png", 700, ground - 400, 400, 20),
...
def create_walls():
    return [
        Platform("assets/map/platform2.png", 2500, 300, 10, 550),
    ]
